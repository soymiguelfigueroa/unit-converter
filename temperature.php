    ...
    <div class="max-w-lg border-2 my-4 mx-auto p-4 rounded-sm">
        ...
        <div>
            <form action="temperature.php" method="post">
                <div class="my-4">
                    <label for="temperature" class="block mb-2 text-sm font-medium text-gray-900">Enter the temperature to convert</label>
                    <input type="text" id="temperature" name="temperature" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                </div>
